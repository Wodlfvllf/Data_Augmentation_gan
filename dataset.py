...
#         self.path = path  # Folder containing frames for a single video
#         self.transform = transform  # Optional image transformation (e.g., resizing, normalization)
#         self.num_frames = len(os.listdir(path))  # Total number of frames
#     def __len__(self):
...
#         path_1, path_2, path_3 = self.path(idx)
